...
namespace StdNounou
{
    ...
    public class ED_UITabsHandler : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(5);
            CreateTab();
            if (targetScript.TabButtonsParent.childCount > 0)
                DestroyTab();
        ...
        private void CreateTab()
        {
            ...
            {
                UITabButton btn = EditorCreates.CreateUITabButton(targetScript.TabButtonsParent.gameObject).GetComponent<UITabButton>();
                UITabElement element = EditorCreates.CreateUITabElement(targetScript.TabElementsParent.gameObject).GetComponent<UITabElement>();
